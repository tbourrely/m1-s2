 ...
 * generated in the tbo.soap.tp3 package. 
...
public class ObjectFactory {
    ...
    private final static QName _HelloWorld_QNAME = new QName("http://tp3.soap.tbo/", "helloWorld");
    private final static QName _HelloWorldResponse_QNAME = new QName("http://tp3.soap.tbo/", "helloWorldResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: tbo.soap.tp3
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tp3.soap.tbo/", name = "helloWorld")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tp3.soap.tbo/", name = "helloWorldResponse")
