 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://tp3.soap.tbo/", wsdlLocation = "http://localhost:8080/SOAPTP3/HelloWorldService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICE_QNAME = new QName("http://tp3.soap.tbo/", "HelloWorldService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/SOAPTP3/HelloWorldService?wsdl");
    ...
    public HelloWorldService getHelloWorldServicePort() {
        return super.getPort(new QName("http://tp3.soap.tbo/", "HelloWorldServicePort"), HelloWorldService.class);
    }
    ...
    public HelloWorldService getHelloWorldServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://tp3.soap.tbo/", "HelloWorldServicePort"), HelloWorldService.class, features);
    }
