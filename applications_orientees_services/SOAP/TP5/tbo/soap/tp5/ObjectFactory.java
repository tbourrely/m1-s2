 ...
 * generated in the tbo.soap.tp5 package. 
...
public class ObjectFactory {
    ...
    private final static QName _HelloWorldResponse_QNAME = new QName("http://tp5.soap.tbo/", "helloWorldResponse");
    private final static QName _HelloWorld_QNAME = new QName("http://tp5.soap.tbo/", "helloWorld");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: tbo.soap.tp5
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tp5.soap.tbo/", name = "helloWorldResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tp5.soap.tbo/", name = "helloWorld")
