 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://tp5.soap.tbo/", wsdlLocation = "http://localhost:8080/SOAPTP5/HelloWorldService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICE_QNAME = new QName("http://tp5.soap.tbo/", "HelloWorldService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/SOAPTP5/HelloWorldService?wsdl");
    ...
    public HelloWorldService getHelloWorldPort() {
        return super.getPort(new QName("http://tp5.soap.tbo/", "HelloWorldPort"), HelloWorldService.class);
    }
    ...
    public HelloWorldService getHelloWorldPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://tp5.soap.tbo/", "HelloWorldPort"), HelloWorldService.class, features);
    }
